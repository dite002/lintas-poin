  ...
  return (
    <div className="flex items-center justify-center py-16 px-4">
      <motion.div
        ...
        className="w-full max-w-md border-2 border-blue-800 bg-white p-6 sm:p-8 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] rounded-xl"
      >
        <div className="text-center space-y-3 mb-8">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-slate-100 text-blue-900 border border-slate-200">
            <ShieldCheck className="h-7 w-7" />
          </div>
          <div>
            <h2 className="font-serif text-2xl font-bold text-blue-900 uppercase tracking-tight">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white py-2 pl-9 pr-4 font-sans text-sm text-blue-900 focus:border-blue-800 focus:ring-1 focus:ring-blue-800 focus:outline-none transition-all"
                    required
                  />
                </div>
              </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center gap-2 w-full rounded-lg bg-blue-600 text-white font-sans text-xs font-bold uppercase tracking-wider py-2.5 hover:bg-orange-500 active:scale-[0.98] transition-all disabled:opacity-50 mt-2 shadow-xs cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div className="mt-6 border-t border-slate-100 pt-4 flex flex-col items-center justify-center gap-2">
          <p className="font-sans text-[11px] text-slate-400">
            Sistem Lintas Poin • Hak cipta Redaktur Terdaftar
          </p>
          <button
            onClick={onCheckStatus}
            className="font-sans text-[11px] font-semibold text-slate-700 hover:underline"
          >
